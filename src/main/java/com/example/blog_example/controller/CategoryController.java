...
public class CategoryController {
    ...
    @Parameter(name = "upperCategorySaveDTO", description = "상위 카테고리 등록 요청 DTO", required = true)
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "상위 카테고리가 생성되었습니다."),
            @ApiResponse(responseCode = "400", description = "해당 번호를 가진 유저가 없습니다.")
    })
    @PostMapping("/upper")
    ...
    @Parameter(name = "lowerCategorySaveDTO", description = "하위 카테고리 등록 요청 DTO", required = true)
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "하위 카테고리가 생성되었습니다."),
            @ApiResponse(responseCode = "400", description = "해당 번호를 가진 상위 카테고리가 없습니다.")
    })
    @PostMapping("/lower")
    ...
    @Parameter(name = "upperCategoryUpdateDTO", description = "상위 카테고리 수정 요청 DTO", required = true)
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "상위 카테고리가 수정되었습니다."),
            @ApiResponse(responseCode = "400", description = "해당 번호를 가진 상위 카테고리가 없습니다.")
    })
    @PutMapping("/upper")
    ...
    @Parameter(name = "lowerCategoryUpdateDTO", description = "하위 카테고리 수정 요청 DTO", required = true)
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "하위 카테고리가 수정되었습니다."),
            @ApiResponse(responseCode = "400", description = "해당 번호를 가진 상위 카테고리가 없습니다."),
            @ApiResponse(responseCode = "400", description = "해당 번호를 가진 하위 카테고리가 없습니다.")
    })
    @PutMapping("/lower")
    ...
    @Parameter(name = "upperCategoryNo", description = "상위 카테고리 번호", example = "1", in = ParameterIn.QUERY, required = true)
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "해당 번호를 가진 상위 카테고리가 삭제되었습니다."),
            @ApiResponse(responseCode = "400", description = "해당 번호를 가진 상위 카테고리가 없습니다.")
    })
    @DeleteMapping("/upper")
    ...
    @Parameter(name = "lowerCategoryNo", description = "하위 카테고리 번호", example = "1", in = ParameterIn.QUERY, required = true)
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "해당 번호를 가진 하위 카테고리가 삭제되었습니다."),
            @ApiResponse(responseCode = "400", description = "해당 번호를 가진 하위 카테고리가 없습니다.")
    })
    @DeleteMapping("/lower")
